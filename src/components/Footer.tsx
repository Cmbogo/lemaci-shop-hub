...
const Footer = () => {
  return (
    <footer className="border-t bg-black text-white mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-2">
              <a href="tel:0713929274" className="flex items-center text-sm text-gray-300 hover:text-primary transition-colors">
                <Phone className="h-4 w-4 mr-2" />
                071 392 9274
              </a>
              <a href="mailto:cicilymbogo820@gmail.com" className="flex items-center text-sm text-gray-300 hover:text-primary transition-colors">
